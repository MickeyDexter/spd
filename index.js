...
🌆 Enter The Active Number You Want To Use As A WhatsApp Bot, Start With Your Country Code.❗ > Example: 254xxx. Now, Try To Follow The Instructions I Gave

🌤️ WhatsApp Number:
`);
   // Request and display the pairing code
   const code = await ryoroyko.requestPairingCode(phoneNumber.trim());
   console.log(color(`Your code: ${code}`, `${randomcolor}`));
}
